// lab2q_mm_interconnect_0.v

// This file was auto-generated from altera_mm_interconnect_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 14.1 186 at 2015.05.24.13:10:18

`timescale 1 ps / 1 ps
module lab2q_mm_interconnect_0 (
		...
		output wire [15:0] pixel_buffer_avalon_pixel_dma_master_readdata,      //                                         .readdata
	...
	wire   [15:0] pixel_buffer_avalon_pixel_dma_master_translator_avalon_universal_master_0_readdata;      // pixel_buffer_avalon_pixel_dma_master_agent:av_readdata -> pixel_buffer_avalon_pixel_dma_master_translator:uav_readdata
	...
	wire    [1:0] pixel_buffer_avalon_pixel_dma_master_translator_avalon_universal_master_0_byteenable;    // pixel_buffer_avalon_pixel_dma_master_translator:uav_byteenable -> pixel_buffer_avalon_pixel_dma_master_agent:av_byteenable
	...
	wire   [15:0] pixel_buffer_avalon_pixel_dma_master_translator_avalon_universal_master_0_writedata;     // pixel_buffer_avalon_pixel_dma_master_translator:uav_writedata -> pixel_buffer_avalon_pixel_dma_master_agent:av_writedata
	wire    [1:0] pixel_buffer_avalon_pixel_dma_master_translator_avalon_universal_master_0_burstcount;    // pixel_buffer_avalon_pixel_dma_master_translator:uav_burstcount -> pixel_buffer_avalon_pixel_dma_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                                       // rsp_mux:src_valid -> pixel_buffer_avalon_pixel_dma_master_agent:rp_valid
	wire   [83:0] rsp_mux_src_data;                                                                        // rsp_mux:src_data -> pixel_buffer_avalon_pixel_dma_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                       // pixel_buffer_avalon_pixel_dma_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                                     // rsp_mux:src_channel -> pixel_buffer_avalon_pixel_dma_master_agent:rp_channel
	...
	wire   [31:0] onchip_mem_s1_agent_m0_address;                                                          // onchip_mem_s1_agent:m0_address -> onchip_mem_s1_translator:uav_address
	...
	wire  [102:0] onchip_mem_s1_agent_rf_source_data;                                                      // onchip_mem_s1_agent:rf_source_data -> onchip_mem_s1_agent_rsp_fifo:in_data
	...
	wire  [102:0] onchip_mem_s1_agent_rsp_fifo_out_data;                                                   // onchip_mem_s1_agent_rsp_fifo:out_data -> onchip_mem_s1_agent:rf_sink_data
	...
	wire   [83:0] pixel_buffer_avalon_pixel_dma_master_agent_cp_data;                                      // pixel_buffer_avalon_pixel_dma_master_agent:cp_data -> router:sink_data
	...
	wire          onchip_mem_s1_agent_rp_valid;                                                            // onchip_mem_s1_agent:rp_valid -> router_001:sink_valid
	wire  [101:0] onchip_mem_s1_agent_rp_data;                                                             // onchip_mem_s1_agent:rp_data -> router_001:sink_data
	wire          onchip_mem_s1_agent_rp_ready;                                                            // router_001:sink_ready -> onchip_mem_s1_agent:rp_ready
	wire          onchip_mem_s1_agent_rp_startofpacket;                                                    // onchip_mem_s1_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire          onchip_mem_s1_agent_rp_endofpacket;                                                      // onchip_mem_s1_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                                                       // cmd_mux:src_valid -> onchip_mem_s1_cmd_width_adapter:in_valid
	wire   [83:0] cmd_mux_src_data;                                                                        // cmd_mux:src_data -> onchip_mem_s1_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                                       // onchip_mem_s1_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [0:0] cmd_mux_src_channel;                                                                     // cmd_mux:src_channel -> onchip_mem_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                                               // cmd_mux:src_startofpacket -> onchip_mem_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                                                 // cmd_mux:src_endofpacket -> onchip_mem_s1_cmd_width_adapter:in_endofpacket
	wire          onchip_mem_s1_cmd_width_adapter_src_valid;                                               // onchip_mem_s1_cmd_width_adapter:out_valid -> onchip_mem_s1_agent:cp_valid
	wire  [101:0] onchip_mem_s1_cmd_width_adapter_src_data;                                                // onchip_mem_s1_cmd_width_adapter:out_data -> onchip_mem_s1_agent:cp_data
	wire          onchip_mem_s1_cmd_width_adapter_src_ready;                                               // onchip_mem_s1_agent:cp_ready -> onchip_mem_s1_cmd_width_adapter:out_ready
	wire    [0:0] onchip_mem_s1_cmd_width_adapter_src_channel;                                             // onchip_mem_s1_cmd_width_adapter:out_channel -> onchip_mem_s1_agent:cp_channel
	wire          onchip_mem_s1_cmd_width_adapter_src_startofpacket;                                       // onchip_mem_s1_cmd_width_adapter:out_startofpacket -> onchip_mem_s1_agent:cp_startofpacket
	wire          onchip_mem_s1_cmd_width_adapter_src_endofpacket;                                         // onchip_mem_s1_cmd_width_adapter:out_endofpacket -> onchip_mem_s1_agent:cp_endofpacket
	wire          router_001_src_valid;                                                                    // router_001:src_valid -> onchip_mem_s1_rsp_width_adapter:in_valid
	wire  [101:0] router_001_src_data;                                                                     // router_001:src_data -> onchip_mem_s1_rsp_width_adapter:in_data
	wire          router_001_src_ready;                                                                    // onchip_mem_s1_rsp_width_adapter:in_ready -> router_001:src_ready
	wire    [0:0] router_001_src_channel;                                                                  // router_001:src_channel -> onchip_mem_s1_rsp_width_adapter:in_channel
	wire          router_001_src_startofpacket;                                                            // router_001:src_startofpacket -> onchip_mem_s1_rsp_width_adapter:in_startofpacket
	wire          router_001_src_endofpacket;                                                              // router_001:src_endofpacket -> onchip_mem_s1_rsp_width_adapter:in_endofpacket
	wire          onchip_mem_s1_rsp_width_adapter_src_valid;                                               // onchip_mem_s1_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire   [83:0] onchip_mem_s1_rsp_width_adapter_src_data;                                                // onchip_mem_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          onchip_mem_s1_rsp_width_adapter_src_ready;                                               // rsp_demux:sink_ready -> onchip_mem_s1_rsp_width_adapter:out_ready
	wire    [0:0] onchip_mem_s1_rsp_width_adapter_src_channel;                                             // onchip_mem_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          onchip_mem_s1_rsp_width_adapter_src_startofpacket;                                       // onchip_mem_s1_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          onchip_mem_s1_rsp_width_adapter_src_endofpacket;                                         // onchip_mem_s1_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (onchip_mem_s1_cmd_width_adapter_src_ready),         //              cp.ready
		.cp_valid                (onchip_mem_s1_cmd_width_adapter_src_valid),         //                .valid
		.cp_data                 (onchip_mem_s1_cmd_width_adapter_src_data),          //                .data
		.cp_startofpacket        (onchip_mem_s1_cmd_width_adapter_src_startofpacket), //                .startofpacket
		.cp_endofpacket          (onchip_mem_s1_cmd_width_adapter_src_endofpacket),   //                .endofpacket
		.cp_channel              (onchip_mem_s1_cmd_width_adapter_src_channel),       //                .channel
	...
	lab2q_mm_interconnect_0_router router (
	...
	lab2q_mm_interconnect_0_router_001 router_001 (
	...
	lab2q_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (sys_sdram_pll_sys_clk_clk),                      //       clk.clk
		.reset              (pixel_buffer_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2q_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (sys_sdram_pll_sys_clk_clk),                      //       clk.clk
		.reset               (pixel_buffer_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab2q_mm_interconnect_0_cmd_demux rsp_demux (
		.clk                (sys_sdram_pll_sys_clk_clk),                         //       clk.clk
		.reset              (pixel_buffer_reset_reset_bridge_in_reset_reset),    // clk_reset.reset
	...
	lab2q_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (sys_sdram_pll_sys_clk_clk),                      //       clk.clk
		.reset               (pixel_buffer_reset_reset_bridge_in_reset_reset), // clk_reset.reset
