...
proc alt_up_generate {dest_path src_path new_module_name params_str sections_str} {
#	send_message info "Starting UP Generation from $src_path to $dest_path"
	...
	set dest_module [ alt_up_modify_module_name $dest_module $new_module_name ]
	set dest_module [ alt_up_modify_params $dest_module $params_str ]
...
proc alt_up_modify_module_name {module_str new_module_name} {
...
proc alt_up_modify_params {module_str params_str} {
