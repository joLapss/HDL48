...
proc generate {} {
	...
	# add_file "$dest_dir/altera_up_irda_counters.$file_ending" SYNTHESIS
	# add_file "$dest_dir/altera_up_irda_in_deserializer.$file_ending" SYNTHESIS
	# add_file "$dest_dir/altera_up_irda_out_serializer.$file_ending" SYNTHESIS
	# add_file "$dest_dir/altera_up_sync_fifo.$file_ending" SYNTHESIS

	# Generate HDL
	source "up_ip_generator.tcl"
	if { $avalon_bus_type == "Memory Mapped" } {
		alt_up_generate "$dest_dir$dest_name.$file_ending" "hdl/altera_up_avalon_mm_irda.$file_ending" "altera_up_avalon_mm_irda" $dest_name $params $sections
	} else {
		alt_up_generate "$dest_dir$dest_name.$file_ending" "hdl/altera_up_avalon_st_irda.$file_ending" "altera_up_avalon_st_irda" $dest_name $params $sections
	}
	# file copy -force "hdl/altera_up_irda_counters.$file_ending" $dest_dir
	# file copy -force "hdl/altera_up_irda_in_deserializer.$file_ending" $dest_dir
	# file copy -force "hdl/altera_up_irda_out_serializer.$file_ending" $dest_dir
